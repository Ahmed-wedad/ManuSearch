...
class SearchAgent:
    ...
    def forward(self, query, mode='iterative', skip_first_planner=False):
        ...
        try:
                ...
                for response in self.iterative(query, skip_first_planner=skip_first_planner):
                    yield response
        except:
            formatted_messages = [
    ...
    def iterative(self, query, skip_first_planner=False):
        """
        Executes the search process iteratively, refining the search results over multiple turns.

        Args:
            query (`str`): The user query to be processed.
            skip_first_planner (`bool`): Whether to skip planner for the first iteration (optimization for new conversations).
